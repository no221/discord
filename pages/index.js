...
const LoadingScreen = () => (
  <div className="fixed inset-0 bg-gradient-to-br from-white via-orange-50 to-amber-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 flex flex-col items-center justify-center z-50 overflow-hidden transition-colors duration-500">
...
export default function Home() {
  ...
  const AnimatedQuantity = ({ quantity }) => {
    ...
    return (
      <span className={`font-semibold transition-all duration-200 ${
        isAnimating ? 'animate-quantity-bounce text-orange-600 dark:text-orange-400 scale-125' : ''
      }`}>
        {displayQty}
      </span>
    )
  ...
  const CartItemWithAnimation = ({ item, index }) => {
    ...
    return (
      <div key={`${item.product.id}-${item.variant.size}-${index}-${priceUpdateKey}`} 
           className="flex items-center gap-3 py-3 border-b border-gray-200 dark:border-gray-600 animate-item-slide-in">
        {renderProductImage(
        ...
        <div className="flex-1">
          <div className="font-medium text-sm text-gray-800 dark:text-gray-200">{item.product.name}</div>
          ...
          <div className="flex items-center gap-2 mt-1">
            <button
              ...
              className="w-5 h-5 flex items-center justify-center bg-gray-200 dark:bg-gray-600 rounded text-xs hover:bg-gray-300 dark:hover:bg-gray-500 transition-all duration-200 transform hover:scale-110 active:scale-95 text-gray-800 dark:text-gray-200"
            >
              -
            </button>
        ...
        <div className="text-right">
          <div className="text-sm font-semibold text-orange-600 dark:text-orange-400 animate-price-spring">
          ...
          {discountRate > 0 && (
            <div className="text-xs text-gray-400 dark:text-gray-500 line-through animate-strike">
              Rp {animatedOriginalPrice.toLocaleString()}
            </div>
          )}
          <button
            onClick={() => removeFromCart(item.product.id, item.variant.size)}
            className="text-red-500 dark:text-red-400 text-xs hover:text-red-700 dark:hover:text-red-300 mt-1 transition-all duration-200 transform hover:scale-110 active:scale-95"
          >
            Hapus
          </button>
        </div>
  ...
  const CheckoutCartItem = ({ item, index }) => {
    ...
    return (
      <div key={`${item.product.id}-${item.variant.size}-${index}-${priceUpdateKey}`} 
        ...
        <div className="flex-1">
          <div className="font-semibold text-sm md:text-base text-gray-800 dark:text-gray-200">{item.product.name}</div>
        ...
        <div className="text-right">
          <div className="font-semibold text-base md:text-lg text-orange-600 dark:text-orange-400 animate-price-spring">
            Rp {animatedItemPrice.toLocaleString()}
          </div>
          {discountRate > 0 && (
            <div className="text-xs text-green-600 dark:text-green-400 animate-fade-in">
  ...
  const AboutPage = () => (
    <div
      className={`max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 transition-colors duration-500 ${
        pageTransition ? "animate-page-exit" : "animate-page-enter"
      }`}
    >
      <div className="text-center mb-8">
        <h1 className="text-3xl md:text-4xl font-bold text-orange-700 dark:text-orange-300 mb-4 animate-fade-in-up">
          Tentang Kami
        </h1>
        <div className="w-24 h-1 bg-orange-500 dark:bg-orange-400 mx-auto mb-6 animate-scale-in"></div>
      </div>

      {/* TIM KAMI */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <div className="animate-slide-in-left">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Tim Kami</h2>
          <div className="space-y-3">
            {[
              ...
              >
                ...
                <div>
                  <div className="font-semibold text-gray-800 dark:text-gray-200">{member.name}</div>
      ...
      {/* HUBUNGI KAMI */}
      <div className="border-t border-gray-200 dark:border-gray-700 pt-8 animate-fade-in-up-delayed">
        <h3 className="text-xl font-semibold text-center mb-6 text-gray-800 dark:text-gray-200">Hubungi Kami</h3>
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">+62 851-5643-1675</div>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">rndm942@yahoo.com</div>
            </div>
          </a>
        </div>
      </div>
      ...
      <div className="text-center mt-8">
        <button
          ...
          className="px-8 py-3 bg-orange-500 dark:bg-orange-600 text-white rounded-lg hover:bg-orange-600 dark:hover:bg-orange-700 transition-all duration-300 transform hover:scale-105 active:scale-95 font-semibold"
        >
  ...
  const Footer = () => (
    <footer className="mt-8 py-6 border-t border-gray-200 dark:border-gray-700 relative z-10 backdrop-blur-sm bg-white/50 dark:bg-gray-800/50 transition-colors duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="inline-block p-4 bg-orange-50 dark:bg-gray-700 rounded-lg hover:bg-orange-100 dark:hover:bg-gray-600 transition-all duration-300 transform hover:scale-105">
              ...
              <div className="font-semibold text-orange-700 dark:text-orange-300 group-hover:text-orange-800 dark:group-hover:text-orange-200 transition-colors">
                Kelompok 4
              </div>
          ...
          <div className="text-center">
            <div className="flex justify-center gap-8">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 transition-all duration-300 transform hover:scale-105"
              >
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg"
                  alt="WhatsApp"
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm font-medium text-gray-700 dark:text-gray-300">0851-5643-1675</div>
                </div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-all duration-300 transform hover:scale-105"
              >
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Gmail_Icon_%282013-2020%29.svg/512px-Gmail_Icon_%282013-2020%29.svg.png"
                  alt="Email"
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm font-medium text-gray-700 dark:text-gray-300">rndm942@yahoo.com</div>
                </div>
              </a>
  ...
  return (
    <div className="min-h-screen p-4 md:p-6 bg-gradient-to-br from-orange-50 via-white to-amber-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-10 w-20 h-20 opacity-20 animate-spin-slow">
          <div className="w-full h-full bg-black dark:bg-white rounded-full flex items-center justify-center">
            <div className="w-16 h-16 bg-white dark:bg-gray-900 rounded-full"></div>
          </div>
        </div>
      ...
      {currentPage !== 'about' && (
        <header className={`flex flex-col md:flex-row md:items-center justify-between mb-6 relative z-30 gap-4 md:gap-0 ${
          ...
          <div className="flex items-center justify-between w-full md:w-auto gap-4">
            <h1 
              className="text-xl md:text-2xl font-bold text-orange-700 dark:text-orange-300 flex items-center gap-2 animate-pulse-gentle cursor-pointer"
              onClick={() => navigateToPage('home')}
            >
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div className="relative">
              ...
              {/* Cart Dropdown */}
              {cartOpen && (
                <div className="cart-container absolute right-0 top-14 w-80 md:w-96 bg-white dark:bg-gray-800 rounded-lg shadow-2xl border border-orange-100 dark:border-gray-600 z-50 max-h-80 overflow-hidden animate-dropdown transition-colors duration-500">
                  <div className="p-4">
                    <h3 className="font-semibold mb-3 text-lg flex items-center gap-2 text-gray-800 dark:text-gray-200">
                      🛒 Keranjang Belanja
                    </h3>
                    
                    {cart.length === 0 ? (
                      <p className="text-gray-500 dark:text-gray-400 text-center py-4">Keranjang kosong</p>
                    ) : (
                      <>
                        ...
                        <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-600">
                          <div className="flex justify-between font-semibold text-lg text-gray-800 dark:text-gray-200">
                            <span>Total:</span>
                            <span className="text-orange-600 dark:text-orange-400 animate-price-spring">Rp {animatedTotalPrice.toLocaleString()}</span>
                          </div>
                          {voucherApplied && (
      ...
      {cartOpen && currentPage !== 'about' && (
        <div className="md:hidden fixed inset-0 bg-black/50 z-40 flex items-end">
          <div className="cart-container bg-white dark:bg-gray-800 rounded-t-2xl w-full max-h-3/4 overflow-y-auto animate-slide-up transition-colors duration-500">
            <div className="p-4">
              <div className="flex justify-between items-center mb-4">
                <h3 className="font-semibold text-lg text-gray-800 dark:text-gray-200">🛒 Keranjang Belanja</h3>
                <button onClick={() => setCartOpen(false)} className="text-2xl transition-transform duration-200 hover:scale-110 text-gray-800 dark:text-gray-200">×</button>
              </div>
        ...
        {currentPage === 'home' && (
          <div className={pageTransition ? 'animate-page-exit' : 'animate-page-enter'}>
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
              <h2 className="text-xl font-semibold mb-4 md:mb-0 text-gray-800 dark:text-gray-200">Semua Produk Bola</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {filteredProducts.map((product) => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-lg text-gray-800 dark:text-gray-200">{product.name}</h3>
                  ...
                  <p className="mt-2 text-lg font-bold text-orange-600 dark:text-orange-400 transition-all duration-300 hover:scale-105">
        ...
        {currentPage === 'product' && selectedProduct && (
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 ${
            ...
            <section className="bg-white dark:bg-gray-800 p-4 md:p-6 rounded-lg shadow-xl backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 transition-colors duration-500 border border-orange-100 dark:border-gray-600">
              ...
              <h2 className="text-xl md:text-2xl font-semibold text-gray-800 dark:text-gray-200">{selectedProduct.name}</h2>
              <p className="text-gray-600 dark:text-gray-400 mt-2 text-sm md:text-base">{selectedProduct.description}</p>
              ...
              <div className="mt-4 md:mt-6">
                <h4 className="font-semibold mb-3 text-gray-800 dark:text-gray-200">Pilih Size:</h4>
                    ...
                    <button
                      ...
                      className={`px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg transition-all duration-300 font-semibold text-sm md:text-base transform hover:scale-105 ${
                        selectedVariant.size === variant.size
                          ...
                          : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:border-orange-500 dark:hover:border-orange-500 hover:shadow-md'
                      }`}
                    >
                      {variant.size}<br/>
              ...
              {selectedVariant && (
                <div className="mt-4 p-4 bg-orange-50 dark:bg-gray-700 rounded-lg animate-price-change transition-colors duration-500">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      {discountRate > 0 && (
                        <div className="text-sm text-gray-400 dark:text-gray-500 line-through animate-strike">
                          Rp {priceBeforeDiscount.toLocaleString()}
                        </div>
                      )}
                      <div className="text-lg font-bold text-orange-600 dark:text-orange-400 animate-price-spring">
                  ...
                  {voucherApplied && (
                    <div className="mt-2 text-xs text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900/30 px-2 py-1 rounded animate-pulse">
              ...
              <div className="grid grid-cols-1 gap-3 md:gap-4">
                {getRecommendedProducts(selectedProduct).map((p) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-sm md:text-base text-gray-800 dark:text-gray-200">{p.name}</div>
                      <div className="text-xs md:text-sm text-gray-600 dark:text-gray-400 transition-all duration-300 hover:scale-105">
          ...
          <div className={`max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 md:p-6 backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 transition-colors duration-500 border border-orange-100 dark:border-gray-600 ${
            ...
            {cart.length === 0 ? (
              <div className="text-center py-8 md:py-12">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-lg mb-6">Keranjang Anda kosong</p>
                <button
                  onClick={() => navigateToPage('home')}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                ...
                <div className="lg:col-span-2">
                  <h3 className="font-semibold text-lg mb-4 text-gray-800 dark:text-gray-200">Items dalam Keranjang</h3>
                ...
                <div className="space-y-4 md:space-y-6">
                  <h3 className="font-semibold text-lg text-gray-800 dark:text-gray-200">Informasi Pelanggan</h3>
                  
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-800 dark:text-gray-200">Nama Lengkap *</label>
                    <input
                      value={form.name}
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-800 dark:text-gray-200">Nomor Telepon *</label>
                    <input
                      value={form.phone}
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-800 dark:text-gray-200">Alamat Lengkap *</label>
                    <textarea
                      value={form.address}
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-800 dark:text-gray-200">Kode Diskon (Opsional)</label>
                    <input
                      value={form.code}
                  ...
                  <div className="payment-container relative">
                    <label className="block text-sm font-medium mb-2 text-gray-800 dark:text-gray-200">Metode Pembayaran *</label>
                    <button
                      onClick={() => setPaymentOpen(!paymentOpen)}
                      className="w-full border border-gray-300 dark:border-gray-600 p-3 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent text-left flex justify-between items-center transition-all duration-300 transform hover:scale-105 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                    >
                      <span>
                        {form.paymentMethod ? 
                    ...
                    {paymentOpen && (
                      <div className="absolute top-full left-0 right-0 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-2xl z-50 max-h-60 overflow-y-auto mt-1 animate-dropdown transition-colors duration-500">
                  ...
                  {/* Total */}
                  <div className="border-t border-gray-200 dark:border-gray-600 pt-4 animate-total-update">
                    ...
                    <div className="flex justify-between text-xl font-bold mt-2 text-gray-800 dark:text-gray-200">
                      <span>Total Pembayaran:</span>
                      <span className="text-orange-600 dark:text-orange-400 animate-price-spring">
                        Rp {animatedTotalPrice.toLocaleString()}
                      </span>
                    </div>
                    {voucherApplied && (
                      <div className="text-sm text-green-600 dark:text-green-400 mt-2 bg-green-50 dark:bg-green-900/30 p-2 rounded animate-pulse">
      ...
      {/* Tambahkan style untuk dark mode transitions */}
      <style jsx global>{`
        :root {
